...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "متجر عربي للمنتجات الرقمية والكورسات التدريبية مع تحميل فوري ووصول مدى الحياة." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "جود | منتجات رقمية وكورسات تدريبية" },
      { property: "og:description", content: "متجر عربي للمنتجات الرقمية والكورسات التدريبية مع تحميل فوري ووصول مدى الحياة." },
